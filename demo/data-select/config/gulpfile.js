...
gulp.task('cssmin',function () {
	...
	.pipe($.minifyCss({
		advanced: false,
		compatibility: 'IE9+',// 类型：String 默认：''or'*' [启用兼容模式； 'ie7'：IE7兼容模式，'ie8'：IE8兼容模式，'*'：IE9+兼容模式]
		keepBreaks: false,
		keepSpecialComments: '*'
	}))
...
gulp.task('jsmin', function () {
	return gulp.src(['!'+ srclj+'/js/zepto.min.js',srclj+'/js/vue.js',srclj+'/js/style.js'])//除了1、3 
