...
function(t) {
	var e, i, r, n, o, s = t.GreenSockGlobals || t,
		...
		l = [].slice,
		u = function() {}, c = {}, d = function(e, i, r, n) {
	...
	var m = [0, 0, 1, 1],
		...
		y = g.map = {}, x = g.register = function(t, e, i, r) {
	...
	var O = M._internals = {}, D = M._plugins = {}, F = M._tweenLookup = {}, L = 0,
		k = O.reservedProps = {
			ease: 1,
			delay: 1,
			overwrite: 1,
	...
	r._init = function() {
		...
		else e = this._initProps(this.target, this._propLookup, this._siblings, o); if (e && M._onPluginEvent("_onInitAllProps", this), o && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), n.runBackwards)
	...
	window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
		...
		var l, u, c, d, p, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
			...
			}, H = k.defaultView ? k.defaultView.getComputedStyle : function() {}, V = s.getStyle = function(t, e, i, r, n) {
				var o;
		...
		var le = function(t, e, i, r) {
			...
			pe = s.parseComplex = function(t, e, i, r, n, o, s, a, h, u) {
				...
				for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (A = A.join(" ").replace(O, ", ").split(" "), C = C.join(" ").replace(O, ", ").split(" "), M = A.length), M !== C.length && (A = (o || "").split(" "), M = A.length), s.plugin = h, s.setRatio = u, c = 0; M > c; c++)
					...
					s["xs" + s.l] += f.substr(p)
				} else s["xs" + s.l] += s.l ? " " + f : f; if (-1 !== r.indexOf("=") && s.data) {
						...
						s.log = S("log"), s.dir = S("dir"), s.memoize = function(t, e) {
							...
							var n = function() {
								...
								a in i ? s.nextTick(function() {
									o.apply(null, i[a])
								}) : a in r ? r[a].push(o) : (r[a] = [o], t.apply(null, n.concat([
									function() {
										i[a] = arguments;
										var t = r[a];
										delete r[a];
			...
			function(e, i, r) {
				! function() {
					...
					n.prototype.delimiter = ".", n.prototype.setMaxListeners = function(t) {
						...
						} else s = this._events[t]; if ("function" == typeof s) {
				...
				e.exports = function() {
					return function(t, e) {
						...
						this.add(t.name + "_image", a, h, function(i) {
							var n = {}, o = t.data.getElementsByTagName("info")[0],
									...
									for (var p = 0, f = 0, m = c.length; m > f; f++) {
										...
										if (v.vertices) {
											...
											if (1 == this.scale)
												...
												for (var V = 0; H > V; V++) Y[V + G] = W[V] * this.scale; if (z)
...
function(t) {
	...
	var r = t("PIXI"),
		...
		a = function(t) {
			this.app = t, r.DisplayObjectContainer.call(this), this.bg = new r.Sprite.fromImage(window.ASSET_URL + "img/skyBG.jpg"), this.addChild(this.bg), this.mini3d = new n, this.addChild(this.mini3d.view), this.speed = -15, this.range = 3e3, this.clouds = [], this.images = ["skyCloud1.png", "skyCloud2.png"];
			for (var e = 0; 50 > e; e++) {
	...
	var r = t("PIXI"),
		...
		s = function() {
			...
			for (var e = 0; 50 > e; e++) blob = new r.Sprite.fromImage(ASSET_URL + "img/blob.png"), blob.target = new r.Point(n.random(-950, 950), n.random(-600, 600)), this.blobs.push(blob), blob.spring = new o, blob.rotationSpeed = n.random(-.1, .1), blob.anchor.set(.5), blob.count = Math.random() * Math.PI * 2, this.container.addChild(blob);
	...
	var n = t("com/fido/app/App"),
		...
		h = function() {
			...
			e.add("x", window.ASSET_URL + "img/skyBG.jpg").add("x1", window.ASSET_URL + "img/skyCloud1.png").add("xx", window.ASSET_URL + "img/skyCloud2.png").add("x2", window.ASSET_URL + "img/spaceBG.jpg").add("x3", window.ASSET_URL + "img/sun_add.png").add("x4", window.ASSET_URL + "img/spaceCloud1.png").add("x5", window.ASSET_URL + "img/spaceCloud2.png").add("x6", window.ASSET_URL + "img/spaceCloud3.png").add("x7", window.ASSET_URL + "img/blob.png").load(this.onAppReady.bind(this)), window.addEventListener("message", function(t) {
